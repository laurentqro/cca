...
class UserTest < ActiveSupport::TestCase
  test 'all users permissions' do
    ...
    assert permission.allow_action?('devise/sessions', :new)
    assert permission.allow_action?('devise/sessions', :create)
  end
  ...
  test 'any logged in user permissions' do
    ...
    assert permission.allow_action?('devise/registrations', :new)
    assert permission.allow_action?('devise/registrations', :create)
    assert permission.allow_action?('devise/sessions', :destroy)
  end
